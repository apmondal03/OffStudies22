...
import { resolveWordWithCache } from "@/lib/dictionary/cachedResolve";
...
async function findWordEntry(slug: string, word: string) {
  ...
  return resolveWordWithCache(word);
}
...
export default async function WordPage({
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 sm:px-6 py-10 sm:py-16">
      ...
      <p className="mt-10 border-t border-border pt-6 text-xs text-ink-faint">
